...
def setup_environment(args, training_team, env_idx=None):
    ...
    env = basketworld.HexagonBasketballEnv(
        ...
        pass_interception_model=getattr(args, "pass_interception_model", "line"),
        pass_passer_pressure_weight=getattr(args, "pass_passer_pressure_weight", 0.0),
        pass_receiver_pressure_weight=getattr(args, "pass_receiver_pressure_weight", 0.0),
        pass_lob_lane_multiplier=getattr(args, "pass_lob_lane_multiplier", 0.35),
        pass_lob_receiver_distance=getattr(args, "pass_lob_receiver_distance", 1.0),
        pass_speed=getattr(args, "pass_speed", 3.5),
        defender_reaction_time=getattr(args, "defender_reaction_time", 0.35),
        defender_speed=getattr(args, "defender_speed", 1.25),
        defender_reach_radius=getattr(args, "defender_reach_radius", 0.65),
        reaction_softness=getattr(args, "reaction_softness", 0.55),
        base_passer_risk=getattr(args, "base_passer_risk", 0.06),
        passer_pressure_decay=getattr(args, "passer_pressure_decay", 1.35),
        base_receiver_risk=getattr(args, "base_receiver_risk", 0.35),
        receiver_alignment_min=getattr(args, "receiver_alignment_min", 0.35),
        receiver_alignment_width=getattr(args, "receiver_alignment_width", 2.0),
        max_receiver_hazard=getattr(args, "max_receiver_hazard", 0.85),
        lane_weight=getattr(args, "lane_weight", 0.0),
        three_point_distance=args.three_point_distance,
        three_point_short_distance=getattr(args, "three_point_short_distance", None),
        three_pt_extra_hex_decay=getattr(args, "three_pt_extra_hex_decay", 0.05),
        ...
        pass_mode=getattr(args, "pass_mode", "directional"),
